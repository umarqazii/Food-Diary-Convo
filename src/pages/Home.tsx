          ...
          >
            ...
            >
              <p style={{ padding: "10px" }}>
                <b>Note:</b> This website is not responsive for screens smaller
                than 610px as we were not given the design for smaller screens{" "}
                <i>
                  (This functionality of rendering completely different elements
                  on different screen sizes is done using a Custom Hook)
                </i>
              </p>
            </div>
          </div>
